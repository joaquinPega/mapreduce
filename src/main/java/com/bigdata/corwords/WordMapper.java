...
/**
 * Maps word occurrences (which words pair with another one)
 * If you have an input as "Hello, today is a nice day"
 * the mapper should output the following tuples:
 * [(hello, today), (today, is), (is, a), (a, nice), (nice, day)]
 */
public class WordMapper extends MapReduceBase implements Mapper<Text, Text, Text, Text> {
     ...
     * @param value - string line to be processed
     * @param collector - where results should be put
     * @param reporter - report progress so that the job is not killed if takes too much time
     * @throws IOException
     */
    @Override
